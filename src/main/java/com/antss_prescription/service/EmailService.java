...
public interface EmailService {
    void sendRegistrationNotificationToAdmin(String adminEmail, String userFullName,
                                             ...
                                             String approvalUrl);
    void sendApprovalEmail(String toEmail, String fullName, String setupToken);
    ...
    void sendCredentialsEmail(String toEmail, String entityName, String username, String setupToken, String roleName, java.time.LocalDate endDate);
}
